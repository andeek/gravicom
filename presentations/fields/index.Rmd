---
title: "gravicom"
subtitle: A web-based tool for community detection in networks
...
nocite: |
  @rs-shiny, @mb-d3, @fortunato2010community, @mcgrath1996seeing, @gc-igraph, @gn-football, @acb-rjson
---

#Introduction | Who cares and why did we make this?
...
#Demo | http://andeek.shinyapps.io/gravicom
...
##Football Example (Cont'd) {.smaller}
```{r echo=FALSE}
...
print(xtable(results[with(results, order(-Proportion)),], align=c("c", "c","p{10cm}","c", "c"), label='tab:football_final'), include.rownames=FALSE, table.placement='H', type="html", sanitize.text.function = function(x)gsub('&lt', '<', gsub('&gt', '>', x)))
```
...
#Graphical Devices | Theory behind the curtain
...
#Conclusions/Further Work | Possible extensions to gravicom
...
#Appendix | Extra stuff and things.
